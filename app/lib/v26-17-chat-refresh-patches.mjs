...
const DRAWER_MESSAGE_HELPER = [
  ...
  "      \".chat-only-section #drawer-messages{display:grid!important;align-content:start!important;grid-auto-rows:max-content!important;flex:1 1 0!important;height:0!important;min-height:0!important;max-height:none!important;overflow-y:auto!important;overflow-x:hidden!important;overscroll-behavior:contain;touch-action:pan-y;-webkit-overflow-scrolling:touch;scrollbar-gutter:stable;scroll-behavior:auto!important;pointer-events:auto!important}\",",
  "      \".chat-only-section #drawer-messages>.message{align-self:start;height:auto!important;min-height:0!important}\",",
  "      \".chat-only-section #drawer-messages>.message.outgoing{align-self:start}\",",
  ...
  "}",
  "",
  "function drawerMessagesMaxScroll(list) {",
  "  if (!list) return 0;",
  ...
  "    else {",
  "      const preserved = previousScrollTop + (list.scrollHeight - previousScrollHeight);",
  "      list.scrollTop = Math.max(0, Math.min(drawerMessagesMaxScroll(list), preserved));",
  "    }",
  "  });",
  "}",
  "",
