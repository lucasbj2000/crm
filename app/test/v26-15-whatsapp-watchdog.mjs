...
assert.match(patch, /v2615Touch\(v2615PrimaryHealth, "message"\)/, "Los mensajes entrantes deben registrar actividad de la línea principal.");
assert.match(patch, /v2615Touch\(runtime\.v2615Health,"message"\)/, "Los mensajes entrantes deben registrar actividad de líneas independientes.");
...
console.log("OK · V26.15 watchdog de WhatsApp: probe real, doble fallo y autorrecuperación sin logout validados.");
